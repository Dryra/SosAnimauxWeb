 ...
 */
class Adherant extends \SosAnimauxFront\FrontOfficeBundle\Entity\Adherant implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'nom', 'prenom', 'email', 'mdp', 'telephone', 'ville', 'adresse', 'age', 'sexe', 'photo', 'photourl', 'etat', 'id');
        }
