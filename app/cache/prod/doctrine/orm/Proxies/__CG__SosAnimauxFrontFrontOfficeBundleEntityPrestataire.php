 ...
 */
class Prestataire extends \SosAnimauxFront\FrontOfficeBundle\Entity\Prestataire implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'nom', 'prenom', 'domaine', 'jourDisp', 'prixServ', 'email', 'tel', 'mdp', 'adr', 'id');
        }
