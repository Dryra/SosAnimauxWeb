 ...
 */
class Adresse extends \SosAnimauxFront\FrontOfficeBundle\Entity\Adresse implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'lat', 'lon', 'ville');
        }
