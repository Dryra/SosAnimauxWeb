 ...
 */
class RendezVous extends \SosAnimauxFront\FrontOfficeBundle\Entity\RendezVous implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'date', 'idRdv', 'idPens', 'idAdh');
        }
