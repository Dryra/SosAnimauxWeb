 ...
 */
class Prestataire extends \SosAnimaux\BackOfficeBundle\Entity\Prestataire implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'nom', 'prenom', 'domaine', 'jourDisp', 'prixServ', 'email', 'tel', 'mdp', 'adr');
        }
