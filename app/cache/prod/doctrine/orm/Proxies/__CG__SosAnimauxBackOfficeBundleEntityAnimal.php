 ...
 */
class Animal extends \SosAnimaux\BackOfficeBundle\Entity\Animal implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'nom', 'espece', 'age', 'race', 'poids', 'couleur', 'vaccin', 'etat', 'autre', 'photo', 'sexe', 'idAdh', 'adr');
        }
